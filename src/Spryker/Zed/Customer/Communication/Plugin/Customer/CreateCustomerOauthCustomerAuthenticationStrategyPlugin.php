 ...
 */
class CreateCustomerOauthCustomerAuthenticationStrategyPlugin extends AbstractPlugin implements OauthCustomerAuthenticationStrategyPluginInterface
{
    /**
     * {@inheritDoc}
    ...
    /**
     * {@inheritDoc}
     * - Finds an existing customer by email, or creates a new one on first login.
     * - Returns null if email is missing or registration fails.
     *
     * @api
     *
     * @param \Generated\Shared\Transfer\ResourceOwnerTransfer $resourceOwnerTransfer
    ...
    public function resolveOauthCustomer(ResourceOwnerTransfer $resourceOwnerTransfer): ?CustomerTransfer
    {
        return $this->getBusinessFactory()
            ->createCreateCustomerAuthenticationStrategy()
